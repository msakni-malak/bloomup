...
const SideBar = () => {
  ...
  return (
      <div className="w-[15vw] min-h-screen bg-[#4F5D2F] shadow-black shadow-md pt-10 flex flex-col items-center justify-between">
      <div className="flex flex-col gap-10">
        <div className="flex flex-row">
          <img src={logo} alt="BloomUp Logo" className="w-8 h-8" />
          <h2 className="text-2xl font-bold font-title text-[#EFEBCE]">BloomUp</h2>
        </div>
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-[#EFEBCE] font-bold text-xl">Hello, {userName || 'Guest'}</p>
        </div>
        <nav className="flex flex-col gap-3 text-xl text-[#EFEBCE]">
          ...
          <NavLink to="/goals" className={({ isActive }) => isActive ? "nav-link active-link" : "nav-link" }>
            Goals
          </NavLink>
          <NavLink to="/habits" className={({ isActive }) => isActive ? "nav-link active-link" : "nav-link" }>
            Habits
          </NavLink>
        ...
        <g clipPath="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)">
          <path 
            d="M0 0c0 137.243-111.257 248.5-248.5 248.5S-497 137.243-497 0s111.257-248.5 248.5-248.5S0-137.243 0 0Z" 
          ...
          />
          <path 
            d="M0 0v32.064c0 13.282 10.767 24.049 24.048 24.049h32.065a8.016 8.016 0 0 1 8.016 8.016v48.097a8.016 8.016 0 0 1-8.016 8.016H8.016c-48.699 0-88.177-39.478-88.177-88.178v-64.128h-56.113a8.016 8.016 0 0 1-8.016-8.017v-48.096a8.016 8.016 0 0 1 8.016-8.016h56.113v-144.291" 
            transform="translate(296.08 288.065)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
          ...
          />
          <path 
            d="M0 0v176.355h41.838a8.015 8.015 0 0 1 7.777 6.072l12.024 48.096c1.265 5.06-2.562 9.961-7.777 9.961H0" 
            transform="translate(296.08 15.516)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
      ...
      >
        ...
        <g clipPath="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)">
          <path 
            d="M0 0h-336.678c-44.271 0-80.161-35.89-80.161-80.161v-336.678c0-44.271 35.89-80.161 80.161-80.161H0c44.271 0 80.161 35.89 80.161 80.161v336.678C80.161-35.89 44.271 0 0 0Z" 
            transform="translate(424.339 504.5)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
          ...
          />
          <path 
            d="M0 0c0-75.262-61.012-136.274-136.274-136.274-75.263 0-136.275 61.012-136.275 136.274s61.012 136.274 136.275 136.274C-61.012 136.274 0 75.262 0 0Z" 
            transform="translate(392.274 256)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
          ...
          />
          <path 
            d="M0 0c0-17.709-14.356-32.065-32.064-32.065-17.709 0-32.065 14.356-32.065 32.065 0 17.708 14.356 32.064 32.065 32.064C-14.356 32.064 0 17.708 0 0Z" 
            transform="translate(440.371 408.307)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
          ...
          />
          <path 
            d="M0 0c-37.564 26.75-89.987 23.378-123.682-10.317-33.694-33.694-37.067-86.117-10.317-123.682" 
            transform="translate(311.663 334.336)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
          ...
          />
          <path 
            d="M0 0c37.565-26.75 89.987-23.377 123.682 10.317 33.694 33.695 37.067 86.117 10.317 123.682" 
            transform="translate(200.337 177.664)" 
            fill="none" 
            stroke="#efebce" 
            strokeWidth="15" 
            strokeLinecap="round" 
